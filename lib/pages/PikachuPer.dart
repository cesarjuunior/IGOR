    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            '- Se o dano recebido for primo, o dano se torna 0\n- Ao receber um dano fatal, causa dano de 5 pontos em todos os jogadores',
          ...
          Divider(height: 10, color: Colors.transparent),
          Text(
            '- Dano par causado é reduzido pela metade',

  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: Image.asset(
          'lib/images/botao_adicionar_sessao.png',
        ),
                  ...
                  child: Column(
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text(
                          'Essa é um texto de teste, fixo, apenas para ser um exemplo que como essa parte da tela vai ficar',
                          style: TextStyle(
...
//                    highlightColor: Colors.transparent,
//                    splashColor: ColorsThema.loginGradientEnd,
